...
public class ConfirmTransactionListener extends AbstractPacketListener<ConfirmTransaction> {
    public ConfirmTransactionListener() {
        super(ConfirmTransaction.class, Direction.DOWNSTREAM, 0);
    }

    @Override
    public void packetReceive(PacketReceiveEvent<ConfirmTransaction> event) {
    ...
    @Override
    public void packetSend(PacketSendEvent<ConfirmTransaction> packetSendEvent) {
