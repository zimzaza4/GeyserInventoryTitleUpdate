...
import re.imc.geyserinventorytitleupdate.listeners.DownstreamWindowOpenListener;
...
public class GeyserInventoryTitleUpdate {
    ...
    public void onProxyInitialization(ProxyInitializeEvent event) {
        Protocolize.listenerProvider().registerListener(new DownstreamWindowOpenListener());
